...
<body> <?php
    ...
    <div id="pastWOrksID" class="pastWorks">
        <p><?php echo lang('downloads'); ?></p>
        <div class="shortLinePasteWork"></div>
        <table class="table table-bordered table-hover">
            <thead class="thead-dark">
                <tr>
                    <th scope="col">
                        <p><?php echo lang('user_name'); ?></p>
                    </th>
                    <th scope="col">
                        <p><?php echo lang('file_name'); ?></p>
                    </th>
                    <th scope="col">
            ...
            <tbody>
                <?php
                $str = "SELECT users.name as 'name', download_history.file_name as 'file', download_history.date as 'date 'FROM `download_history`,users WHERE users.user_id = download_history.user_id";
